...
export IMAGE_URL=${IMAGE_URL-quay.io/lucarval-rhtap/go-azure-runner-image:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/lucarval-rhtap/go-azure-runner-image-gitops
